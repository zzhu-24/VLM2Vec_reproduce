...
# --- Optional: Step 0 - Compute head importance scores ---
# Run this once before training to generate the head_importance.json and heatmap:
#
# python compute_head_importance.py \
#     --model_name $MODEL_NAME \
#     --dataset_config "$DATASET_CONFIG_PATH" \
#     --data_basedir "$DATA_BASEDIR" \
#     --output_dir $EXP_DIR/head_importance \
#     --delete_L 30 \
#     --delete_n 23 \
